...
const Home = () => (
  <main className="homepage">
    ...
    <p className="home-content2">
      The mind of man has perplexed itself with many hard questions.Is space infinite,
      and in what sense? Is the material world infinite in extent,
      and are all places within that extent equally full of matter?
      Do atoms exist or is matter infinitely divisible?
    </p>
  </main>
);
